...
describe('Button', () => {
  const buttonElement = () => {
    return {
      generateNumbers: screen.queryByRole('button', {
        name: /generate numbers/i,
      }),
      cleanAll: screen.queryByRole('button', { name: /clean all/i }),
  ...
  describe('Generate numbers button', () => {
    ...
    it('should be invisible after the first draw is finished', () => {
      renderButtonComponent('Generate numbers', true, true, 'generateBtn');
      expect(buttonElement().generateNumbers).toBeNull();
    });
  ...
  describe('Clean all button', () => {
    it('should be in the document', () => {
      ...
      expect(buttonElement().cleanAll).toBeTruthy();
    });
    ...
    it('should be invisible before the first draw is finished', () => {
      renderButtonComponent('Clean all', false, false, 'cleanBtn');
      expect(buttonElement().cleanAll).toBeNull();
    });
  ...
  describe('Next button', () => {
    it('should be in the document', () => {
      ...
      expect(buttonElement().next).toBeTruthy();
    });
    ...
    it('should be invisible before the first draw is finished', () => {
      ...
      expect(buttonElement().next).toBeNull();
    });
